...
$base_path = '/projet-php/'; // Ajustez ceci selon votre configuration XAMPP
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="input-group custom-search-input">
                        <input type="search" class="form-control" placeholder="Rechercher un produit..." aria-label="Rechercher" aria-describedby="button-addon2">
